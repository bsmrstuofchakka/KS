...
<div class="social clear">
    <div class="searchbtn clear">
        {!! Form::open(array('url' => url('/pCategoryWSearch'), 'files' => true, 'class'=>'d-flex justify-content-between') )  !!}

        <input type="text" name="searchPW"   value="@if(!empty($searchPW)) {{$searchPW->$searchPW}} @endif" placeholder="Search keyword..."/>
