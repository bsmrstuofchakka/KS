...
<div class="social clear">
    <div class="searchbtn clear">
        {!! Form::open(array('url' => url('answers/search').'?id='.$sharing->id, 'files' => true, 'class'=>'d-flex justify-content-between') )  !!}

        <input type="text" name="searchAnswer"   value="@if(!empty($searchAnswer)) {{$searchAnswer->searchAnswer}} @endif" placeholder="Search keyword..."/>
