							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->name}}</h2>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->did}}</h2>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->dname}}</h2>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->iname}}</h2>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<h2  class="form-control">{{$particularPro->phone}}</h2>
									</div>
								</div>
				...
				<div class="pictureProfile">
					<div class="card card-profile">
						...
						<div class="card-body">
							...
							<a href="#" class="btn btn-primary btn-round"> {{$qCount}} @if($qCount>1) Questions @else Question @endif</a>

							<a href="#" class="btn btn-primary btn-round">{{$aCount}}  @if($aCount>1) Answers @else Answer @endif </a>
							<a href="#" class="btn btn-primary btn-round">{{$rCount}}  @if($rCount>1) Replies @else Reply  @endif </a>
						</div>
					</div>
				</div>
